...
const MarketingPage = () => {
    ...
    const templates = [
        { id: 1, type: 'SMS', trigger: 'Appointment Confirmation', message: 'Hello {client}, your appointment at Glamour Style is confirmed for {date} at {heure}. See you soon!', active: true },
        { id: 2, type: 'WhatsApp', trigger: 'Reminder D-1', message: 'Hi {client}! A quick reminder for your {service} tomorrow at {heure}. Any issues? Please let us know! ✨', active: true },
        { id: 3, type: 'SMS', trigger: 'Birthday', message: 'Happy Birthday {client}! 🎂 Enjoy -15% on your next visit with the code BDAY15.', active: false },
        { id: 4, type: 'WhatsApp', trigger: 'Post-Care Follow-up', message: 'Hey {client}, we hope you love your {service}! Feel free to leave us a review here: [Link]', active: true },
    ];
        ...
        <div className="space-y-10 animate-fadeIn min-h-screen pb-20">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-gray-500 text-base font-medium mt-1">Automate client relationships via SMS and WhatsApp.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">SMS Sent (Month)</p>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">WhatsApp Automated</p>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Open Rate</p>
                    <p className="text-3xl font-black text-green-600">98.2%</p>
                    <p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">vs 22% for emails</p>
                </div>
            </div>
                        ...
                        <div key={tpl.id} className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative group">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-gray-400 uppercase">{tpl.active ? 'Active' : 'Paused'}</span>
                                </div>
                            </div>
            ...
            <div className="bg-gradient-to-br from-[#25D366] to-[#128C7E] p-10 rounded-3xl text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                    <h2 className="text-3xl font-heading mb-6 leading-tight font-bold">Why WhatsApp?</h2>
                    <ul className="space-y-4 mb-8">
                        <li className="flex gap-4">
                            <span className="text-2xl">⚡</span>
                            <p className="text-white/90 text-sm font-medium">Massive reduction in "No-Shows" through interactive reminders.</p>
                        </li>
                        <li className="flex gap-4">
                            <span className="text-2xl">📈</span>
                            <p className="text-white/90 text-sm font-medium">Increase average basket by suggesting complementary treatments (Hair Care).</p>
                        </li>
                        <li className="flex gap-4">
                            <span className="text-2xl">🤝</span>
                            <p className="text-white/90 text-sm font-medium">Humanized and direct relationship compared to a standard automated SMS.</p>
                        </li>
                    </ul>
