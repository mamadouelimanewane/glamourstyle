...
const CalendarPage = () => {
    ...
    const appointments = [
        { id: 1, client: 'Zainab A.', service: 'Braids', time: '10:00', duration: 2, day: 'Wed', color: 'bg-blue-100 border-blue-200 text-blue-700' },
        { id: 2, client: 'Aminata K.', service: 'Silk Press', time: '14:00', duration: 1.5, day: 'Thu', color: 'bg-amber-100 border-amber-200 text-amber-700' },
        { id: 3, client: 'Binta D.', service: 'Color', time: '09:00', duration: 3, day: 'Fri', color: 'bg-emerald-100 border-emerald-200 text-emerald-700' },
        { id: 4, client: 'Yasmine B.', service: 'Care', time: '11:00', duration: 1, day: 'Mon', color: 'bg-rose-100 border-rose-200 text-rose-700' },
    ];
    ...
    return (
        <div className="space-y-10 animate-fadeIn min-h-screen pb-20">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl font-heading font-bold text-gray-950">Salon Calendar</h1>
                    <p className="text-gray-500 text-base font-medium mt-1">Overview of staff occupancy and stations.</p>
                </div>
                <div className="flex bg-gray-200/50 p-1.5 rounded-xl border border-gray-200">
                    <button className="px-5 py-2 rounded-lg text-xs font-black uppercase tracking-widest bg-white text-gray-950 shadow-sm">Weekly</button>
                    <button className="px-5 py-2 rounded-lg text-xs font-black uppercase tracking-widest text-gray-400 hover:text-gray-950 transition-all">Daily</button>
                    <button className="px-5 py-2 rounded-lg text-xs font-black uppercase tracking-widest text-gray-400 hover:text-gray-950 transition-all">Monthly</button>
                </div>
            </div>
                                            ...
                                            >
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    <button
                                                        ...
                                                        title="Notify about delay (WhatsApp)"
                                                        onClick={() => alert(`Sending emergency WhatsApp to ${appointment.client} to notify about a delay.`)}
                                                    >
                                                        📲
                                                    </button>
                                                </div>
                                                <div className="mt-2 flex items-center justify-between">
                                                    ...
                                                    <span className="text-[7px] font-black uppercase tracking-widest opacity-60">In Progress</span>
                                                </div>
                                            </div>
                                        )}
                                    </div>
            ...
            <div className="flex flex-wrap items-center gap-8 pt-4">
                <div className="flex items-center gap-4">
                    <span className="text-xs font-black uppercase tracking-widest text-gray-400">Stations / Staff:</span>
